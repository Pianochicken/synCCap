...
dpm sandbox --json-api-port 7575 --dar .daml/dist/synccap-v5-0.1.0.dar  # Start sandbox
```
...
| File | Purpose |
|:-----|:--------|
| `backend/package.json` | Dependencies: `@daml.js/synccap-v5-0.1.0`, `hono`, `@hono/node-server`, `@hono/zod-openapi`, `jsonwebtoken`, `winston` |
