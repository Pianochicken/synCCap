...
export declare const CapacityAsset:
  damlTypes.Template<CapacityAsset, undefined, '#synccap:SynCCap:CapacityAsset'> &
...
export declare const PenaltyAgreement:
  damlTypes.Template<PenaltyAgreement, undefined, '#synccap:SynCCap:PenaltyAgreement'> &
...
export declare const TransferRFQ:
  damlTypes.Template<TransferRFQ, undefined, '#synccap:SynCCap:TransferRFQ'> &
