// Generated from ../Main/module.daml
...
export declare interface CapacityAssetInterface {
  ...
  InitiatePenalty: 
    ...
    damlTypes.ChoiceFrom<damlTypes.Template<CapacityAsset, undefined>>;
  ProposeTransfer: 
    damlTypes.Choice<CapacityAsset, ProposeTransfer, damlTypes.ContractId<TransferRFQ>, undefined> &
    damlTypes.ChoiceFrom<damlTypes.Template<CapacityAsset, undefined>>;
}
export declare const CapacityAsset:
  damlTypes.Template<CapacityAsset, undefined, '#synccap:Main:CapacityAsset'> &
...
export declare const PenaltyAgreement:
  damlTypes.Template<PenaltyAgreement, undefined, '#synccap:Main:PenaltyAgreement'> &
...
export declare interface TransferRFQInterface {
  ...
  Archive: 
    ...
    damlTypes.ChoiceFrom<damlTypes.Template<TransferRFQ, undefined>>;
  RejectTransfer: 
    damlTypes.Choice<TransferRFQ, RejectTransfer, {}, undefined> &
    damlTypes.ChoiceFrom<damlTypes.Template<TransferRFQ, undefined>>;
  WithdrawRFQ: 
    damlTypes.Choice<TransferRFQ, WithdrawRFQ, {}, undefined> &
    damlTypes.ChoiceFrom<damlTypes.Template<TransferRFQ, undefined>>;
}
export declare const TransferRFQ:
  damlTypes.Template<TransferRFQ, undefined, '#synccap:Main:TransferRFQ'> &
  damlTypes.ToInterface<TransferRFQ, never> &
  TransferRFQInterface

export declare type WithdrawRFQ = {
}

export declare const WithdrawRFQ:
  damlTypes.Serializable<WithdrawRFQ>
